...
Use this checklist for a code release. Lexhint uses a dynamic setuptools-scm version, so confirm that the checked-out tag or commit resolves to the intended version before publishing.
